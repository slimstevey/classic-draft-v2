...
export const axiePartTypes = [AxiePartType.Eyes, AxiePartType.Mouth, AxiePartType.Ears, AxiePartType.Horn, AxiePartType.Back, AxiePartType.Tail]
...
export const ACESSORY_SLOTS = ['body-air', 'body-cheek', 'body-ground', 'body-hip', 'body-neck']
